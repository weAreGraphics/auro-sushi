                ...
                if (categoryId === 2) {
                    proteinSelectHTML = `
                        ...
                        <select id="protein-${product.id}" class="protein-select">
                            <option value="normal" data-price="0">Norma (+0)</option>
                            <option value="pollo" data-price="500">Pollo (+$500)</option>
                            <option value="carne" data-price="700">Carne (+$700)</option>
                            <option value="tofu" data-price="400">Tofu (+$400)</option>
                            <option value="salmon" data-price="800">Salmón (+$800)</option>
                            <option value="camarones" data-price="900">Camarones (+$900)</option>
                            <option value="atun" data-price="850">Atún (+$850)</option>
                            <option value="queso crema" data-price="300">Queso Crema (+$300)</option>
                        </select>
                    `;
                }
